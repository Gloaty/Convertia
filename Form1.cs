...
namespace MP4_to_WAV_Converter {
    public partial class Form1 : Form {
        ...
        private void conversionLogic() {
            ...
            void ConvertPdfToPng(string inputFilePath, string outputFilePath) {
                PdfDocument document = PdfReader.Open(inputFilePath, PdfDocumentOpenMode.ReadOnly);
        ...
        private void convertFrom_SelectedIndexChanged(object sender, EventArgs e) {
            ...
            string[] PDFConversionOptions = ["PNG", "JPG"];
            ...
            if (convertFrom.Text == "PDF") {
                convertTo.Items.AddRange(PDFConversionOptions);
            }
        }
    }
}